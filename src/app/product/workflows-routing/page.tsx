...
export const metadata = generatePageMetadata({
  ...
  description:
    "Build sophisticated automation with drag-and-drop workflows. No coding required. Smart routing, conditional logic, and 50+ pre-built templates for e-commerce, SaaS, and support ops.",

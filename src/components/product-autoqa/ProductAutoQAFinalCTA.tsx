...
export default function ProductAutoQAFinalCTA() {
  return (
    <>
      ...
      <div className="relative rounded-3xl border border-primary/30 bg-gradient-to-br from-card/50 via-background/30 to-card/50 backdrop-blur-2xl p-6 md:p-12 lg:p-16 shadow-2xl text-center overflow-hidden">
        ...
        <div className="relative">
          <motion.h2
            className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-foreground mb-5 md:mb-7 lg:mb-8 leading-tight"
          ...
          <motion.p
            className="text-lg sm:text-xl md:text-2xl text-muted-foreground mb-8 md:mb-10 lg:mb-12 max-w-3xl mx-auto leading-relaxed"
            initial={{ opacity: 0 }}
          ...
          <motion.div
            className="flex flex-col sm:flex-row gap-4 md:gap-5 lg:gap-6 justify-center mb-8 md:mb-10 lg:mb-12"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          {/* Social proof */}
          <motion.div
            className="flex flex-wrap items-center justify-center gap-4 md:gap-6 lg:gap-8 pt-6 md:pt-7 lg:pt-8 border-t border-border/30"
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            viewport={{ once: true }}
